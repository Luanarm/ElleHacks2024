    ...
    return (
        <div id="location">
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div className="text-white text-center sm:text-4xl md:text-3xl lg:text-2xl p-4" style={{ flex: '50%', padding: '10px' }}>
                    <p>York University Bergeron Centre for Engineering Excellence</p>
                    <a href='https://www.google.com/maps/dir//11+Arboretum+Ln,+North+York,+ON+M3J+2S5/@43.7722033,-79.5890895,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x882b2f83ec72aef9:0x5fc298e10a6b0d11!2m2!1d-79.5066888!2d43.7722329?hl=en-US&entry=ttu' style={{ color: 'white' }}>11 Arboretum Ln, North York, ON M3J 2S5</a>
                </div>
