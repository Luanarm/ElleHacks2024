...
function MeetTheTeam() {
  return (
    <div id="meet-team-section" className="App justify-center">
      <header className="App-header text-center">
        ...
        <div className="flex items-center justify-center">
          <div className="flex grid-cols-12 gap-2 place-items-center place-content-center justify-center">
        ...
        <div className="flex items-center justify-center">
          <div className="flex grid-cols-14 gap-2 place-items-center place-content-center justify-center">
        ...
        <div className="flex items-center justify-center">
          <div className="flex grid-cols-12 gap-2 place-items-center place-content-center justify-center pb-8">
